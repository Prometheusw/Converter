...
u8 LastFramFlag=0xff;
u8 alreadlyuptrack=0xff;//已经上轨帧接受标志
u8 alreadlydowntrack=0xff;//已经下轨帧接受标志
u8 FramRecTimeFlag[4]={0x00};//帧接受粗略计时标志
u8 ISorNotPermisionDo=0;//预动任务是否没有被释放
CAN_DATA_FRAME * LastPermissionFARM;//上一帧预动备份
