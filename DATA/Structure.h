...
enum _MISSIONKINDS
{
	MISSION_PROMISSION,//00 预动
	MISSION_CARPASS,//01  //直通，已经不用
	MISSION_CARCHAGE,//02  //真实任务
	MISSION_FINDZERO,//03  //找零
	MISSION_CHEKSELF,//04 //自检查
	MISSION_LOCATION,//05 //定位
	MISSION_MOVE,//06   //移动
};
